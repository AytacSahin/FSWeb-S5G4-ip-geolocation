...
var ipBilgisi = function ipBilgisi(ipObject) {
  ...
  ulke.textContent = "".concat(ipObject.ülke, " (").concat(ipObject.ülkeKodu, ")");
  cardInfo.appendChild(ulke);
  var enlemBilgisi = document.createElement("p");
  enlemBilgisi.textContent = "Enlem: ".concat(ipObject.enlem, " Boylam: ").concat(ipObject.boylam);
  cardInfo.appendChild(enlemBilgisi);
  var sehirBilgisi = document.createElement("p");
  sehirBilgisi.textContent = "\u015Eehir: ".concat(ipObject.şehir);
  cardInfo.appendChild(sehirBilgisi);
  var saatBilgisi = document.createElement("p");
  saatBilgisi.textContent = "Saat Dilimi: ".concat(ipObject.saatdilimi);
  cardInfo.appendChild(saatBilgisi);
  var paraBirimi = document.createElement("p");
  paraBirimi.textContent = "Para Birimi: ".concat(ipObject.parabirimi);
  cardInfo.appendChild(paraBirimi);
  var ispBilgisi = document.createElement("p");
  ispBilgisi.textContent = "ISP: ".concat(ipObject.isp);
